      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          >
            ...
            <button
              type="submit"
              className="group flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-indigo-600 text-sm font-medium text-white transition hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:ring-offset-2 focus:ring-offset-[#0a0a0f]"
            >
              Ingresar
